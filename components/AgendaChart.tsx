...
export const AgendaChart = forwardRef<AgendaChartRef, AgendaChartProps>(({ activities }, ref) => {
    ...
    const labels = dataActivities.map(act => {
        ...
        datasets: [
            {
                ...
                data: dataActivities.map(act => Math.round(act.plannedDuration / 60)),
            ...
            },
            {
                ...
                data: dataActivities.map(act => act.actualDuration !== null ? Math.round(act.actualDuration / 60) : 0),
